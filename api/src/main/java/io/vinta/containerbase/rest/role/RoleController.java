...
public class RoleController implements RoleApi {
	...
	public RoleResponse getRole(Long roleId) {
		return RoleResponseMapper.INSTANCE.toResponse(roleQueryService.getRole(MapstructCommonDomainMapper.INSTANCE
				.longToRoleId(roleId)));
	...
	public RoleResponse createRole(CreateRoleRequest request) {
		return RoleResponseMapper.INSTANCE.toResponse(roleCommandService.createRole(RoleRequestMapper.INSTANCE.toCreate(
	...
	public RoleResponse updateRole(Long roleId, UpdateRoleRequest request) {
		return RoleResponseMapper.INSTANCE.toResponse(roleCommandService.updateRole(RoleRequestMapper.INSTANCE.toUpdate(
	...
	public Paging<RoleResponse> queryRole(QueryRolePaginationRequest request) {
		...
		return RolePaginationMapper.INSTANCE.toPagingResponse(roleQueryService.queryRoles(pagingQuery.withFilter(
